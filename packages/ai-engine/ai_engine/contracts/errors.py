...
ERROR_CODES: Final[dict[str, str]] = {
    ...
    "URL_FETCH_DNS": "URL_FETCH_DNS",
    "URL_FETCH_NETWORK": "URL_FETCH_NETWORK",
...
HTTP_STATUS: Final[dict[str, int]] = {
    ...
    "AUTH_INVITE_INVALID": 403,
    "AUTH_REGISTRATION_DISABLED": 403,
    "AUTH_VERIFICATION_INVALID": 400,
    "AUTH_VERIFICATION_EXPIRED": 400,
    "AUTH_VERIFICATION_RATE_LIMITED": 429,
