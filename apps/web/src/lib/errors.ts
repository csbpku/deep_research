...
export const ERROR_HTTP_STATUS: Record<ErrorCode, number> = {
  ...
  [ERROR_CODES.CSRF_ORIGIN_MISMATCH]: HTTP_STATUS.FORBIDDEN,
  ...
  [ERROR_CODES.URL_FETCH_DNS]: HTTP_STATUS.BAD_GATEWAY,
  [ERROR_CODES.URL_FETCH_NETWORK]: HTTP_STATUS.BAD_GATEWAY,
  ...
  [ERROR_CODES.UPSTREAM_RATE_LIMITED]: HTTP_STATUS.TOO_MANY_REQUESTS,
