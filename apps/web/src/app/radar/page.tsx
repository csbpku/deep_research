...
import { ChevronDown, Layers3, ListOrdered, Search, Workflow } from 'lucide-react';
...
export default function RadarPage() {
  ...
  const [view, setView] = useState<'source' | 'ranked'>(() => searchParams.get('view') === 'source' ? 'source' : 'ranked');
