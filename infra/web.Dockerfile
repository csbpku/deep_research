...
ENV AUTH_BETA_MODE=0
ENV AUTH_EMAIL_VERIFICATION=0
ENV READING_EXTENSION_BETA_URL=
ENV READING_EXTENSION_BETA_PATH=
ENV READING_EXTENSION_BETA_VERSION=0.2.3
