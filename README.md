...
- **测试指标（2026-07-30 实测）**：Web 单测 253 ✅、Web E2E 21 passed/2 skipped ✅、Python 单测 270 + 1 skipped（+39 W9 收尾）✅、Python E2E 11 passed/2 skipped ✅、typecheck + ruff 全绿、GitHub Actions CI 已配置（`.github/workflows/ci.yml`）。
